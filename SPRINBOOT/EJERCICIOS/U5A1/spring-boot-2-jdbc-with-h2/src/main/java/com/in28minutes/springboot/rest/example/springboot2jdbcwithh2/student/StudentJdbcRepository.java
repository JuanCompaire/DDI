...
public class StudentJdbcRepository {
    ...
    public Student findBypassport_number(String passport_number){
        return jdbcTemplate.queryForObject("select * from student where passport_number=?", new Object[]{
            passport_number
        },
        new BeanPropertyRowMapper<Student>(Student.class));
    }
    ...
    public int deletedBypassport_number(String passport_number){
        return jdbcTemplate.update("delete from student where passport_number=?", new Object[]{
                passport_number
        });
    }
